...
Difficulty: EasyAccuracy: 65.19%Submissions: 24K+Points: 2

Given a non-negative number n and two values l and r. The problem is to toggle the bits in the range l to r in 
the binary representation of n, i.e., to toggle bits from the lth least significant bit to the rth least significant bit \
...
Your Task:
You don't need to read input or print anything. Your task is to complete the function toggleBits() which 
takes three Integers n, l and r as input and returns the modified Integer as the answer.*/
